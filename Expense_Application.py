...
def input_data():
    ...
    button_open_calendar = tk.Button(input_data_window, text="Add date", command=input_data_calendar, width=20,
                                     height=1)
...
def show_dashboard():
    ...
    def open_calendar():
        ...
        label_start_calendar = tk.Label(open_calendar_window, text="Choose starting date", font=("Arial", 14),
                                        anchor="center")
        label_start_calendar.grid(row=0, column=1)
        label_end_calendar = tk.Label(open_calendar_window, text="Choose ending date", font=("Arial", 14),
                                      anchor="center")
    ...
    button_open_calendar = tk.Button(show_dashboard_window, text="Open Calendar", command=open_calendar, width=20,
                                     height=1)
